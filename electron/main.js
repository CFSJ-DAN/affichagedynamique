...
function createWindow() {
  ...
  const mainWindow = new BrowserWindow({
    ...
    fullscreen: true, // Démarrer en plein écran
  ...
  mainWindow.webContents.on('before-input-event', (event, input) => {
    // Bloquer tous les raccourcis sauf Échap pour quitter le plein écran
    if (input.key !== 'Escape') {
...
// Gestionnaires IPC pour la synchronisation du contenu
